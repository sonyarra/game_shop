...
| Роль            | Права                                                                                              |
|-----------------|----------------------------------------------------------------------------------------------------|
| **Пользователь** | ![user](photo/user.jpg) Просмотр каталога, фильтрация, добавление в корзину, управление корзиной    |
| **Администратор** | ![admin](photo/admin.jpg) Полное управление играми (CRUD), загрузка изображений, управление пользователями |
...
В результате разработки было создано веб-приложение для покупки игр.
